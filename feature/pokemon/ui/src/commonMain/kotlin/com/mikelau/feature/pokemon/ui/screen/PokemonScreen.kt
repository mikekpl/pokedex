...
import com.mikelau.feature.pokemon.ui.res.Res
            ...
            Column(
                ...
                Row(
                    ...
                    TextField(
                        ...
                        leadingIcon = {
                            AsyncImage(
                                model = Res.getUri("files/ic_search.svg"),
                        ...
                        modifier = Modifier
                            ...
                            .clickable {
                                if (isNumeric(query.value)) {
                                    ...
                                    onPokemonClick(queryPokemonNumber)
                                }
                            },
                        shape = RoundedCornerShape(12.dp)
                    ) {
                        Box(
                            ...
                            AsyncImage(
                                modifier = Modifier
                                    ...
                                    .size(24.dp),
                                model = Res.getUri("files/ic_syncalt.svg"),
                                contentDescription = null,
                                colorFilter = ColorFilter.tint(ColorBackground)
                            )
                        }
                    }
                }
